...
// ✅ Receive user as prop — no Redux needed, no empty state on reload
type Props = {
    user: {
        name?: string;
        email?: string;
                ...
                <div className="sidebar-widgets">
                    ...
                    <div className="notification-card">
                        ...
                        <div className="notification-item">
                            ...
                            <div className="notification-message">Your prescription from Dr. Chen has been sent to your pharmacy</div>
