            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
                        {isEditing 
                            ...
                            : 'Welcome to Zydoc! Please provide a few more details to help us personalize your healthcare experience.'}
                    </p>
                </div>
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="pt-6 flex justify-end">
                        <Button type="submit" disabled={loading || success} className="w-full sm:w-auto px-8 py-3 rounded-xl text-base font-semibold shadow-lg shadow-blue-500/30 transition-all hover:scale-[1.02]" icon={loading ? <i className="fas fa-spinner fa-spin"></i> : success ? <i className="fas fa-check"></i> : (isEditing ? <i className="fas fa-save"></i> : <i className="fas fa-check-circle"></i>)}>
                            {loading ? 'Saving Profile...' : success ? 'Profile Saved!' : (isEditing ? 'Update Profile' : 'Complete Profile')}
                        </Button>
                    </div>
                </form>
            </div>
