...
function generateHalfHourSlots(rawWH: any, consultationType: string, date: Date) {
    ...
    const slots: { time: string; status: "available"|"booked"|"past"; available: boolean }[] = [];
...
export default function BookingForm({ doctor }: { doctor: any }) {
    ...
    const [allSlots, setAllSlots]     = useState<{ time: string; status: "available"|"booked"|"past"; available: boolean }[]>([]);
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5">
                    ...
                    {isLoadingSlots ? (
                        ...
                        <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                            ...
                            <div>
                                ...
                                <p className="text-amber-600 text-xs mt-0.5">
                                    Please choose a different date from the calendar above.
                                </p>
                            </div>
                        </div>
                        ...
                        /* All slots are past or booked — show them read-only + suggestion */
                        <>
