...
//       setPhone(user.phone || '');
//       setBio(user.bio || '');
//       setAvatarPreview(user.avatarUrl || null); // Assuming avatarUrl exists in your user object
//     }
//   }, [user]);
...
//     const profileData = { firstName, lastName, phone, bio };
...
//         <p className="text-xs text-slate-400">Update your basic identity visibility details and bio.</p>
//       </div>
...
//             className="w-24 h-24 rounded-full border-2 border-dashed border-slate-300 dark:border-slate-600 flex flex-col items-center justify-center cursor-pointer overflow-hidden relative group bg-white dark:bg-[#151732] shadow-sm mb-3"
//           >
//             {avatarPreview ? (
...
//                 <span className="block text-[10px] text-slate-400 mt-1 font-semibold">Upload</span>
//               </div>
//             )}
...
//           </div>
//           <h4 className="text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase">Display Profile Photo</h4>
//         </div>
...
//               className="w-full rounded-xl border border-slate-300 dark:border-[#24274d] bg-white dark:bg-[#151732] px-4 py-2.5 text-sm text-slate-800 dark:text-slate-100 outline-none focus:ring-2 focus:ring-blue-500/20 transition resize-none leading-relaxed shadow-sm"
//             />
//           </div>
//         </div>
//       </div>
