...
export default function ScheduleManager({ initialData }: ScheduleManagerProps) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.data?.success) alert('Availability hours saved successfully!');
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
            ...
            <div className="space-y-3 pt-2">
                {schedule && schedule[activeTab] && days.map((day) => {
                    ...
                    if (!slot && day !== 'fullWeek') return null;
